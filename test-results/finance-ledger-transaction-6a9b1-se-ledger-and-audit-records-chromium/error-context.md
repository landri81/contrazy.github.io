...
- Name: finance-ledger.spec.ts >> transaction cancel keeps deposit status CANCELLED but still writes release ledger and audit records
- Location: tests\e2e\finance-ledger.spec.ts:387:5
