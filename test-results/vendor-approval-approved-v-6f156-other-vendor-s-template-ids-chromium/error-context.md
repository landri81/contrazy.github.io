...
- Name: vendor-approval.spec.ts >> approved vendor can create a transaction and cannot use another vendor's template ids
- Location: tests\e2e\vendor-approval.spec.ts:43:5
          ...
          - generic [ref=e40]:
            - generic [ref=e41]:
              ...
              - textbox "Email" [active] [ref=e43]:
                ...
                - text: e2e-approved@contrazy.test
            - generic [ref=e44]:
              - generic [ref=e45]:
