...
- Name: finance-ledger.spec.ts >> vendor partial deposit capture records the fixed fee breakdown against the captured amount
- Location: tests\e2e\finance-ledger.spec.ts:274:5
